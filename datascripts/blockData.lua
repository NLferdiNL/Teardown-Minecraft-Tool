...
blocks = 
	{ --Block Name, 				      		Vox Path, 							      			Axis Rotation, 		  		Block Properties,			Block Size,					Offset,						specialFeatures(shape), alwaysProp, blockType (block, door, slab, fence, stairs, trapdoor, redstone, fencegate), ExtraXML, AltXML}
		...
		{"TNT", 				     			"MOD/vox/blocks/tnt.vox", 				  			{x = 0, y = 0,  z = 0}, 	"tags='explosive=2'", 		{x = 16, y = 16, z = 16},	{x = 16, y = 16, z = 16},	nil, 					false, 		7, nil}, 
		...
		{"Block Of Redstone",       			"MOD/vox/blocks/blockofredstone.vox",	      		{x = 0, y = 0,  z = 0}, 	"",							{x = 16, y = 16, z = 16},	{x = 16, y = 16, z = 16},	nil, 					false, 		7, "<light pos='0.8 0.9 0.8' type='sphere' color='1 0.00 0.00' size='0.25 0.25' unshadowed='1.25'/>"},
