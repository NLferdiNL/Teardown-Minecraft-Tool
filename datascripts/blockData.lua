...
blocks = 
	{ --Block Name, 				      		Vox Path, 							      			Axis Rotation, 		  		Block Properties,			Block Size,					Offset,						specialFeatures(shape), alwaysProp, blockType (block, door, slab, fence, stairs, trapdoor), ExtraXML}
		...
		{"Oak Trapdoor", 		      			"MOD/vox/blocks/oaktrapdoor.vox",		      		{x = 0, y = 1,  z = 0}, 	"",							{x = 16, y = 16, z = 16},	{x = 16, y = 16, z = 16},	nil, 					true,  		6, "<joint size='0.2' pos='1.0 0.1 0.1' rot='0 90 90' limits='-90 0' type='hinge' sound='true' collide='false'/> <joint size='0.2' pos='1.0 0.1 0.9' rot='0 90 90' limits='-90 0' type='hinge' sound='true' collide='false'/>"},
		...
		{"Mangrove Trapdoor", 					"MOD/vox/blocks/mangrovetrapdoor.vox",				{x = 0, y = 0,  z = 0}, 	"",							{x = 16, y = 2, z = 16},	{x = 16, y = 16, z = 16},	nil, 					true,  		6, "<joint size='0.2' pos='1.0 0.1 0.1' rot='0 90 90' limits='-90 0' type='hinge' sound='true' collide='false'/> <joint size='0.2' pos='1.0 0.1 0.9' rot='0 90 90' limits='-90 0' type='hinge' sound='true' collide='false'/>"},
